...
>> openssl s_client -connect localhost:31795 -ign_of
...
# we can change the `$myname=bandit23` and then you can copy all the bash script in the terminal. and you can print the script on the terminal. Boom we get the flag for the next          password.


# Same challenge like before but in it we need to know more about bash and know how the    bash works a.k.a shell scripting in the automated and get the flags.
